                ...
                <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#controllers-links-module-AppModule-1fdea8224fa7043349cdeb60b88abcea"' : 'data-target="#xs-controllers-links-module-AppModule-1fdea8224fa7043349cdeb60b88abcea"' }>
                                            <span class="icon ion-md-swap"></span>
                                            <span>Controllers</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="controllers-links-module-AppModule-1fdea8224fa7043349cdeb60b88abcea"' :
                                            'id="xs-controllers-links-module-AppModule-1fdea8224fa7043349cdeb60b88abcea"' }>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/CreateFileOptions.html" data-type="entity-link">CreateFileOptions</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="interfaces/MD5Passthrough.html" data-type="entity-link">MD5Passthrough</a>
                            </li>
                            <li class="link">
